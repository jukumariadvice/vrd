    ...
    <b-row>
      <b-col cols="12">
        <div class="text-center">
          <b-button class="mr-1" href="https://jukumariadvice.github.io/vrd/docs/data.xlsx">.xls</b-button>
          <b-button class="mr-1" href="https://jukumariadvice.github.io/vrd/docs/data.pdf">.pdf</b-button>
          <b-button class="mr-1" href="https://jukumariadvice.github.io/vrd/docs/data.csv">.csv</b-button>
        </div>
      </b-col>
    </b-row>
    <div id="tools"></div>
